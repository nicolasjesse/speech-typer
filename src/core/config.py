"""Configuration management for Holler."""
    ...
    def load(cls, config_path: Path | None = None) -> "Config":
        ...
        if config_path.exists():
            try:
                ...
                config.correction_provider = data.get(
                    "correction_provider", config.correction_provider
                )
                ...
                config.voice_commands_enabled = data.get(
